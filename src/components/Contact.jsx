  ...
  return (
    <div name='contact' className='w-full h-screen bg-[#160F19] flex justify-center items-center p-4'>
        <form method='POST' action="https://getform.io/f/warkwjpb" className='flex flex-col max-w-[600px] w-full'>
            <div className='pb-8'>
                <p className='text-4xl font-bold inline border-b-4 border-[rgb(106,50,44)] text-[#d9ab60]'>Contact</p>
                <p className='text-[#d9ab60] py-4'>For more information, please complete the form below and I will get back to you</p>
            </div>
